...
Route::post('/edit_profile', 'UserController@updateProfile')->name('updateProfile');
...
Route::get('/prodi/tawarmk', [ProdiController::class, 'tawarMataKuliah'])->name('tawarMataKuliah');

Route::middleware(['auth'])->group(function () {
    Route::get('/prodi/dashboard', 'ProdiController@dashboard')->name('prodi.dashboard');

#Route::get('/prodi/tawar-mk', [ProdiController::class, 'tawarMataKuliah'])->name('tawarMataKuliah');

Route::post('/prodi/store-mk', [ProdiController::class, 'storeMataKuliah'])->name('storeMataKuliah');
